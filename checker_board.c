/**************************************************************************************************
This program creates a black and white checkerboard effect using an older version of OpenGL. 
It was initially written as a test project when learning OpenGL using the RedBook. 
This code may now be deprecated with the release of newer versions of OpenGL
